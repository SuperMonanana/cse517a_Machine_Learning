...
[bestC,bestP,bestval,allerrs]=crossvalidate(xTr,yTr,'rbf',2.^[-1:5],2.^[-2:2]);
[bestC,bestP,bestval,allerrs]=crossvalidate(xTr,yTr,'rbf',2.^[bestC-21:0.25:bestC+],2.^[bestP-1:0.25:bestP+1]);
bestC=2^bestC;
bestP=2^bestP;
